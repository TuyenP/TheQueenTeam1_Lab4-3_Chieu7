...
namespace Lab4_3.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var reservations = db.Reservations.Include(r => r.Customer).Include(r => r.Seat).Include(r => r.Show).Include(r=>r.Show.Movie).Include(r=>r.Show.ShowDay)
                .Include(r => r.Show.ShowTime).Include(r => r.Show.Cinema);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ShowId = new SelectList(db.Shows, "Id", "Show");
            return View();
        }
